        ...
        <section className="flex flex-col md:flex-row items-center mt-16 max-w-4xl mx-auto">
          <div className="md:w-1/2 p-4">
            ...
            <p className="text-gray-600 mt-4">
              ...
              <span className="font-bold">Interactive Media Design</span>. I
              enjoy creating intuitive and accessible digital experiences. I
              love working in{" "}
              <span className="font-bold">Adobe Creative Cloud</span>, where I
              flex my creative muscles and bring my ideas to life. From
            ...
            <p className="text-gray-600 mt-4">
              ...
              mindset. I'm all about designing products that don't just look
              great but are genuinely useful and easy to navigate. Whether it's
              transitioning new concepts or refining the user journey, I'm here
              to make sure every interaction is seamless and enjoyable.{" "}
